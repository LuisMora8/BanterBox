...
def student_schedule():
    ...
    # populate tables
    userAdd =  Users(10,'Erick Vargas','ErickVargas@gmail.com','pass123')
    db.session.add(userAdd)
    db.session.commit()

    userAdd2 =  Users(20,'Able Getachew','AbleGetachew@gmail.com','pass456')
    db.session.add(userAdd2)
    db.session.commit()

    userAdd3 =  Users(30,'Luis Mora','LuisMora@gmail.com','pass789')
    db.session.add(userAdd3)
    db.session.commit()

    postAdd =  Posts(102,10,'Blinker Fluid', 'What is blinker fluid?')
